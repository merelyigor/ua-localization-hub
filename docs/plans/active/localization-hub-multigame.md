...
**RC READY / OWNER NATIVE SMOKE PENDING.** Release Candidate #37 / run `36166009527` succeeded from exact source SHA `5c2c3a71fac3f0b57405c3494db4327f2a02295d`, automatically resolving to `1.2.9` / `v1.2.9`. Artifact ID `10878006746`, name `BDO-UA-Client-v1.2.9-win-x64`, outer ZIP size `67,905,336` bytes and SHA-256 `c43ae054a3a349158607d5de69f923df216a8f4db9ade06c61545e178400b298`. The flat bundle contains exactly the EXE, schema-2 manifest, SHA256SUMS and generated release notes. EXE size `162,466,846` bytes, SHA-256 `610329b4b59eef49092a9a721d88e4b4919aff914764c82cd2221d3584f9910d`, FileVersion `1.2.9.0`, ProductVersion `1.2.9`; manifest source/run/hash and release notes were verified. The later docs-only commit is not the proposed release tag target; if publication is authorized, `v1.2.9` must target the exact RC source SHA above. Production publication is **NOT AUTHORIZED**; tag and GitHub Release have not been created. Next release action: Owner native smoke of the exact RC EXE.
