...
- v1.2.9 lifecycle: **RELEASED / PUBLIC VERIFIED / LIVE v1.2.8 → v1.2.9 UPDATE PENDING**. Owner native RC smoke and Architect GO FOR PUBLICATION are recorded; actual live client update has not yet been performed. `NEXT.json` is reset to empty schema-v1 after archiving released copy.
