...
- Next implementation action: **OWNER DECISION REQUIRED**; Stage 8C is complete and no further implementation stage is authorized. Current release action: Owner native smoke of the exact v1.2.9 RC EXE.
...
- v1.2.9 RC: run #37 / ID `36166009527` SUCCESS from frozen source `5c2c3a71fac3f0b57405c3494db4327f2a02295d`; auto-resolved `1.2.9` / `v1.2.9`. Artifact `10878006746`, outer ZIP `67,905,336` bytes / SHA-256 `c43ae054a3a349158607d5de69f923df216a8f4db9ade06c61545e178400b298`; EXE `162,466,846` bytes / SHA-256 `610329b4b59eef49092a9a721d88e4b4919aff914764c82cd2221d3584f9910d`, FileVersion `1.2.9.0`, ProductVersion `1.2.9`. Manifest, sums, four-file layout and generated notes verified. Owner smoke pending; no tag/release created and publication is not authorized.
